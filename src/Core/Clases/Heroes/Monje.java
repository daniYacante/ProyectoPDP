...
public class Monje extends Core.Clases.Heroes.Heroe {
    public Monje(){
        ...
        this.habilidad1=new Habilidad("Artes Marciales", -8, 0, 0);
        this.habilidad2=new Habilidad("Lanzar Dardos", 10, 0, -10);
        this.habilidadEspecial=new Habilidad("Golpe Divino (Habilidad Especial)", -16, 0, 0);//Buscar
